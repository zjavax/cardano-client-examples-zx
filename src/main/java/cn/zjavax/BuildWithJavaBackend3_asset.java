...
//        transferAsset.setReceiverAddress("addr_test1qq4pxvsevncnfd7ppmatyavej7kjcukwxugrnk9rsejufvpfqqgflwz7ahhqezd8mx5hfxmwh2stfagm8uwkxreya6rsqfxnz7");
        ...
        transferAsset1.setAmount(1);
        transferAsset1.setDecimals(0l);
        ...
        transferAsset2.setAmount(1);
        transferAsset2.setDecimals(0l);
        ...
        List<TransferAsset> transferAssetList = List.of(transferAsset1,transferAsset2);

        String prettyJson = JsonUtil.getPrettyJson(transferAssetList);
    ...
    public long getTokenDecimals(String policyId, String assetName) throws ApiException {
        ...
        return decimals == null ? 0 : decimals.asLong();
    }
}
